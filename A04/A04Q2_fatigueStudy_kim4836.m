...
% ENGR 132 
% Program Description 
% This program processes dispatcher fatigue study data by importing
% datasets, performing specified analyses, and displaying professionally
% formatted results in MATLAB.  
%
